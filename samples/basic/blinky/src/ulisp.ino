...
object *writepacket (object *args, object *env) {
  // takes a ptr + a list
  checkargs(args);

  // uint8_t* buf = checkinteger(car(args));
  uint8_t *buf = packet;
  object *list = car(cdr(args));

  int i = 0;
  while (list != NULL) {
    buf[i] = checkinteger(car(list));
    list = cdr(list);
    i++;
  }

  // return last addr written to
  return number((int)&buf[i-1]);
}
...
const char string253[] PROGMEM = "write-packet";
const char string254[] PROGMEM = ":constlat";
const char string255[] PROGMEM = ":hfclkstart";
const char string256[] PROGMEM = ":radio-power";
const char string257[] PROGMEM = ":radio-shorts";
const char string258[] PROGMEM = ":radio-txpower";
const char string259[] PROGMEM = ":radio-mode";
const char string260[] PROGMEM = ":radio-base0";
const char string261[] PROGMEM = ":radio-prefix0";
const char string262[] PROGMEM = ":radio-pcnf0";
const char string263[] PROGMEM = ":radio-pcnf1";
const char string264[] PROGMEM = ":radio-crccnf";
const char string265[] PROGMEM = ":radio-crcpoly";
const char string266[] PROGMEM = ":radio-crcinit";
const char string267[] PROGMEM = ":radio-datawhiteiv";
const char string268[] PROGMEM = ":radio-frequency";
const char string269[] PROGMEM = ":radio-packetptr";
const char string270[] PROGMEM = ":radio-disabled";
const char string271[] PROGMEM = ":radio-txen";
...
const char doc253[] PROGMEM = "(write-list-to-mem ptr memlen lst)";
...
const tbl_entry_t lookup_table[] PROGMEM = {
  ...
  { string253, writepacket, 0222, doc253 },
  { string254, (fn_ptr_type)&NRF_POWER->TASKS_CONSTLAT, REGISTER, NULL },
  { string255, (fn_ptr_type)&NRF_CLOCK->TASKS_HFCLKSTART, REGISTER, NULL },
  { string256, (fn_ptr_type)&NRF_RADIO->POWER, REGISTER, NULL },
  { string257, (fn_ptr_type)&NRF_RADIO->SHORTS, REGISTER, NULL },
  { string258, (fn_ptr_type)&NRF_RADIO->TXPOWER, REGISTER, NULL },
  { string259, (fn_ptr_type)&NRF_RADIO->MODE, REGISTER, NULL },
  { string260, (fn_ptr_type)&NRF_RADIO->BASE0, REGISTER, NULL },
  { string261, (fn_ptr_type)&NRF_RADIO->PREFIX0, REGISTER, NULL },
  { string262, (fn_ptr_type)&NRF_RADIO->PCNF0, REGISTER, NULL },
  { string263, (fn_ptr_type)&NRF_RADIO->PCNF1, REGISTER, NULL },
  { string264, (fn_ptr_type)&NRF_RADIO->CRCCNF, REGISTER, NULL },
  { string265, (fn_ptr_type)&NRF_RADIO->CRCPOLY, REGISTER, NULL },
  { string266, (fn_ptr_type)&NRF_RADIO->CRCINIT, REGISTER, NULL },
  { string267, (fn_ptr_type)&NRF_RADIO->DATAWHITEIV, REGISTER, NULL },
  { string268, (fn_ptr_type)&NRF_RADIO->FREQUENCY, REGISTER, NULL },
  { string269, (fn_ptr_type)&NRF_RADIO->PACKETPTR, REGISTER, NULL },
  { string270, (fn_ptr_type)&NRF_RADIO->EVENTS_DISABLED, REGISTER, NULL },
  { string271, (fn_ptr_type)&NRF_RADIO->TASKS_TXEN, REGISTER, NULL },
#elif defined(CPU_iMXRT1062)
  { string232, (fn_ptr_type)INPUT, PINMODE, NULL },
  { string233, (fn_ptr_type)INPUT_PULLUP, PINMODE, NULL },
  { string234, (fn_ptr_type)INPUT_PULLDOWN, PINMODE, NULL },
