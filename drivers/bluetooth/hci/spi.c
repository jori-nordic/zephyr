...
static int bt_spi_send_aci_config(uint8_t offset, uint8_t *value, size_t value_len);
...
int bt_spi_bluenrg_setup(struct bt_hci_setup_params *params)
{
	int ret;
	bt_addr_t *addr = params->public_addr;
