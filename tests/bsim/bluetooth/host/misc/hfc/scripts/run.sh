...
Execute "${bsim_exe}" -v=${verbosity_level} -s=${simulation_id} -d=2 -testid=peer_1 -rs=1337

Execute ./bs_2G4_phy_v1 -v=${verbosity_level} -s=${simulation_id} -D=3 -sim_length=400e6 $@
