...
void bt_iso_send_cb(struct bt_conn *iso, void *user_data, int err);
#endif
...
/* #if defined(CONFIG_BT_ISO) */
/* 			/\* TODO: move that to tx_notify() instead, only call after all frags *\/ */
/* 			if (conn->type == BT_CONN_TYPE_ISO) { */
/* 				LOG_INF("early iso cb"); */
/* 				bt_iso_send_cb(conn, NULL, 0); */
/* 				continue; */
/* 			} */
/* #endif */
			...
			/* TODO: should we call the callbacks from here directly? */
...
#define _COMPILE_TX (IS_ENABLED(CONFIG_BT_CONN) ||		\
		     IS_ENABLED(CONFIG_BT_ISO_UNICAST) ||	\
