...
BUILD_ASSERT(CONFIG_BT_L2CAP_TX_USER_DATA_SIZE >= sizeof(struct tx_meta),
	     "User data size is too small!");
		    ...
		    bt_conn_tx_cb_t cb, void *user_data)
{
	...
	if (buf->user_data_size < CONFIG_BT_L2CAP_TX_USER_DATA_SIZE) {
